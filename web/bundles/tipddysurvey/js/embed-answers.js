...
jQuery(document).ready(function () {
	...
	//AÃ±ade un enlace para borrar la answer relacionada
	...
	{
		//AÃ±ade el enlace "New Answer"
	    collectionHolder.append($newLinkLi);
		
     	$addAnswersLink.on('click', function(e){
	  
	       //evita la redirecciÃ³n
	       e.preventDefault();
	    
	       //AÃ±ade una nueva Answer en el siguiente bloque de cÃ³digo
